  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/apotek.png" alt="Logo" height="50"> <b>Apotek Indri Farma</b>
      </div><!-- /.login-logo -->
      <?php  
      ...
      <div class="login-box-body">
        ...
        <form action="login-check.php" method="POST">
          ...
          <div class="row">
            ...
            <br><center><p>Repost by <a href='https://apotekindrifarma/' title='Apotekindrifarma' target='_blank'>ApotekIndriFarma</a></p></center>
