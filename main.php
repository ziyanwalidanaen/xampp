    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <span style="font-size:20px">Apotek Indri Farma</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2023 </a>.</strong> | Apotek Indri Farma
