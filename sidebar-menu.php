...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
	...
	if ($_GET["module"]=="beranda") { ?>
		<li class="active">
			<a href="?module=beranda"><i class="fa fa-home"></i> Home </a>
	  	</li>
	<?php
	}
  ...
  <?php
	...
	// jika menu reset password dipilih, menu reset password aktif
	if ($_GET["module"]=="password") { ?>
		<li class="active">
			<a href="?module=password"><i class="fa fa-lock"></i> Reset Password</a>
		</li>
	<?php
	}
	// jika tidak, menu reset password tidak aktif
	else { ?>
		<li>
			<a href="?module=password"><i class="fa fa-lock"></i> Reset Password</a>
		</li>
